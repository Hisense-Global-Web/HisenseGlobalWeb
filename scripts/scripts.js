...
function loadDelayedImages() {
  ...
  if (currentHostname.includes('hisense-dev') || currentHostname.includes('hisensesitestage') || currentHostname.includes('hisensesitedev') || currentHostname.includes('localhost')) {
