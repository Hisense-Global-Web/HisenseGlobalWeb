...
const translateDictionary = {
  ...
  COMPARE_PRODUCT_MODELS: {
    en: 'Compare Product Models',
    es: 'Comparar modelos de productos',
    fr: 'Comparer les modèles de produits',
    pt: 'Comparar modelos de produtos',
    zh: '对比产品型号',
    'zh-tw': '比較產品型號',
    ja: '製品モデルを比較する',
    th: 'เปรียบเทียบรุ่นสินค้า',
    ar: 'مقارنة طرازات المنتجات',
    ko: '제품 모델 비교',
  },
